						...
						<form class="form-horizontal" action="<?= base_url('auth/'); ?>registration" method="post">
							<div class="card-body">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="inputEmail3" placeholder="username" name="username" value="<?= set_value('username') ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="inputPassword3" placeholder="nama" name="nama" value="<?= set_value('nama') ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="password" class="form-control" id="inputPassword3" placeholder="Passsword" name="password" value="<?= set_value('password') ?>">

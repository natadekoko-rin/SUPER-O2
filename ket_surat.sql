...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2020 at 02:20 AM
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Agus Supriyanto', 'IMG20151225122130.jpg', 'Ketua RW 2', 1, 1, 2),
...
ALTER TABLE `pengantar`
  ...
  ADD KEY `NIK` (`NIK`),
  ADD KEY `no_pengantar` (`no_pengantar`);
